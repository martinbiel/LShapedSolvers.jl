...
dlsolvers = [(LShapedSolver(:dls,solver,κ=1.0,log=false),"L-Shaped"),
             (LShapedSolver(:drd,solver,σ=60.0,σ̲=10.0,σ̅=200.0,κ=1.0,log=false),"RD L-Shaped"),
             (LShapedSolver(:dtr,solver,Δ=50.0,Δ̅=100.0,κ=1.0,log=false),"TR L-Shaped"),
             (LShapedSolver(:dlv,solver,λ=1.0,κ=1.0,log=false),"Leveled L-Shaped")]
